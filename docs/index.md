...
Let's go back to the detaset we mentioned in the video: 'Beach_Water_Quality'. Load the dataset in R (Make sure you installed `tidyverse` package first):
